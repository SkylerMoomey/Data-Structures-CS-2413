// Driller0.4.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	ResizableArray<DrillingRecord> *records = new ResizableArray<DrillingRecord>(1);
